...
import com.borland.dx.util.cons.*;
import com.borland.javax.sql.DataSourcePropertiesBeanInfo;
...
public class MemoryDataSourceRepository extends DataSourceRepository {
            ...
            java.lang.IllegalAccessException
  {
    ...
    if (i == methods.length) {
      throw new DataSourceException(Res.bundle.format(ResIndex.PropNotFound, setMeth));
    }
      ...
      if (name.startsWith("set")) { //NORES
        ...
        if (parameterTypes.length == 1 && isPropertyParameterType(parameterTypes[0])) {
          ...
          if (getterMethod == null)
            getterMethod = (Method) dataSourceMethods.get("is"+baseName); //NORES
          if (getterMethod != null && baseName.equals("StringProperties") && dataSource instanceof com.borland.javax.sql.DataSourceProperties) //NORES
            getterMethod = null;
