...
public class ProcedureResolver extends SQLResolver
{
  ...
  /**
   * Frees any system resources used for statements associated
   *  with the specified StorageDataSet.
